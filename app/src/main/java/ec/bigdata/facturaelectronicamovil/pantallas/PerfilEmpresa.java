                        ...
                        if (response.isSuccessful()) {
                            ...
                            try {
                                ...
                                if (o.get("status").getAsBoolean() == true) {
                                    ...
                                    Toast.makeText(PerfilEmpresa.this, "Obligado a llevar contabilidad actualizado.", Toast.LENGTH_SHORT).show();
                                }
                            } catch (IOException e) {
                                e.printStackTrace();
                            }
    ...
    private class ActualizacionPerfilEmpresaAsyncTask extends AsyncTask<String, Integer, Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result.equals(Boolean.FALSE)) {
                if (!errores.equals("")) {
                    Toast.makeText(PerfilEmpresa.this, errores, Toast.LENGTH_SHORT).show();
                }
            }
        }
    ...
    private void actualizarPerfilEmpresa() {
        ...
        if (!correoPrincipalActualizado.trim().equals("")) {
            if (Validaciones.isEmail(correoPrincipalActualizado)) {
                            ...
                            if (response.isSuccessful()) {
                                ...
                                try {
                                    ...
                                    if (o.get("status").getAsBoolean() == true) {
                                        ...
                                        Toast.makeText(PerfilEmpresa.this, "Información de empresa actualizada.", Toast.LENGTH_SHORT).show();
                                    }
                                } catch (IOException e) {
                                    e.printStackTrace();
                                }
                ...
                Toast.makeText(PerfilEmpresa.this, "El correo principal no es válido.", Toast.LENGTH_SHORT).show();
            }
        } else {
            Toast.makeText(PerfilEmpresa.this, "El correo principal no puede estar vacío.", Toast.LENGTH_SHORT).show();
        }
