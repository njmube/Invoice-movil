...
public class ActualizacionCliente extends AppCompatActivity {
    ...
    private boolean validarIdentificacion() {
        ...
        if (ec.bigdata.facturaelectronicamovil.utilidades.Utilidades.validarIdentificacion(editTextIdentificacionCliente.getText().toString())) {
                ...
                call.enqueue(new Callback<ec.bigdata.facturaelectronicamovil.modelo.Cliente>() {
                    ...
                    public void onResponse(Call<ec.bigdata.facturaelectronicamovil.modelo.Cliente> call, Response<ec.bigdata.facturaelectronicamovil.modelo.Cliente> response) {
                        if (response.isSuccessful()) {
                            ...
                            if (cliente != null) {
                                Toast.makeText(ActualizacionCliente.this, "La identificación está siendo usada por otro cliente", Toast.LENGTH_SHORT).show();
                ...
                call.enqueue(new Callback<ec.bigdata.facturaelectronicamovil.modelo.Cliente>() {
                    ...
                    public void onResponse(Call<ec.bigdata.facturaelectronicamovil.modelo.Cliente> call, Response<ec.bigdata.facturaelectronicamovil.modelo.Cliente> response) {
                        if (response.isSuccessful()) {
                            ec.bigdata.facturaelectronicamovil.modelo.Cliente cliente = response.body();
                            if (cliente != null) {
                                Toast.makeText(ActualizacionCliente.this, "El correo electrónico está siendo usada por otro cliente", Toast.LENGTH_SHORT).show();
        ...
        if (validarIdentificacion() && validarCorreoPrincipal()) {
            ...
            responseBodyCall.enqueue(new Callback<ResponseBody>() {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        try {
                            ...
                            if (o.get("status").getAsBoolean() == true) {
                                ...
                                Toast.makeText(ActualizacionCliente.this, "Cliente actualizado.", Toast.LENGTH_SHORT).show();
                            }
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                ...
                public void onFailure(Call<ResponseBody> call, Throwable t) {
                    Toast.makeText(ActualizacionCliente.this, "Error al actualizar el cliente.", Toast.LENGTH_SHORT).show();
