...
public class Establecimiento extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<List<Secuencial>> callSecuencial = servicioSecuencial.obtenerSecuencialesPorEmpresa(claseGlobalUsuario.getIdEmpresa());
    ...
    private void actualizarInformacionEstablecimiento() {
        ...
        responseBodyCall = servicioSecuencial.actualizarEstablecimiento(claseGlobalUsuario.getIdEmpresa(), codigoEstablecimientoEditado, puntoEmisionEditado, direccionEstablecimientoEditado);
                ...
                if (response.isSuccessful()) {
                    ...
                    try {
                        ...
                        if (o.get("status").getAsBoolean() == true) {
                            Intent intentInformacionTributaria = new Intent(getApplicationContext(), InicioFacturacionElectronica.class);
                            intentInformacionTributaria.putExtra(String.valueOf(Codigos.CODIGO_ESTABLECIMIENTO_ACTUAL), establecimientoSecuencialSeleccionado);
                            setResult(RESULT_OK, intentInformacionTributaria);
                            finish();
                        }
                    } catch (IOException e) {
                        e.printStackTrace();
