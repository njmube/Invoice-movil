    ...
    private void actualizarProducto() {
        ...
        call.enqueue(new Callback<ResponseBody>() {
                ...
                if (response.isSuccessful()) {
                    ...
                    try {
                        ...
                        if (o.get("status").getAsBoolean() == true) {
                            ...
                            Toast.makeText(ActualizacionProducto.this, "Producto actualizado.", Toast.LENGTH_SHORT).show();
                        }
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                Toast.makeText(ActualizacionProducto.this, "Error al actualizar el producto.", Toast.LENGTH_SHORT).show();
            }
        });
